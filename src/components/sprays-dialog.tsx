...
import { AddOrEditProductDialog } from './products-dialog';
import { AddOrEditSprayForm } from './sprays-form';
...
import { deleteSpray } from '@/services/sprays.service';
...
export const AddOrEditSprayDialog = ({ data }: Props) => {
...
export const DeletePulverizacionDialog = ({ id }: { id: UUID }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await deleteSpray(id, access_token);
      setState('success');
