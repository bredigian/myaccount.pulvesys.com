...
import { AddOrEditCropForm } from './crops-form';
...
import { deleteCrop } from '@/services/crops.service';
...
export const AddOrEditCropDialog = ({
  isEdit,
  data,
  hidden,
  customOpen,
...
export const DeleteCropDialog = ({ id }: { id: UUID }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await deleteCrop(id, access_token);
