...
import {
  BackToSpraysButton,
  EditProductConsumeDialog,
  ShareSprayDialog,
  ShowSprayInfoDialog,
} from '@/components/spray-detail-dialog';
import {
  Calendar,
  FileWarning,
  Layers,
...
import { DeletePulverizacionDialog } from '@/components/sprays-dialog';
...
export default function SprayDetailContainer({ data, pulverizaciones }: Props) {
              ...
              <CardContent className='flex flex-wrap items-center gap-4 overflow-y-auto'>
                <ul className='w-full space-y-4'>
                  {data?.Aplicacion?.map((aplicacion) => {
                    ...
                    const defaultValues: ApplicationWithConsume = {
                          ...
                          <TableBody className='overflow-auto'>
                            <TableRow>
                              <TableCell>
                                ...
                                {
                                  SHORT_UNITY[
                                    aplicacion.producto?.unidad as UNITY
                                  ]
                                }
                                /ha
                              </TableCell>
