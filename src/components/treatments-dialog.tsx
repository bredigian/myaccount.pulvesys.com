...
import { AddOrEditTreatmentForm } from './treatments-form';
...
import { deleteTreatment } from '@/services/treatments.service';
...
export const AddOrEditTreatmentDialog = ({
  isEdit,
  data,
  hidden,
  customOpen,
...
export const DeleteTreatmentDialog = ({ id }: { id: UUID }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await deleteTreatment(id, access_token);
